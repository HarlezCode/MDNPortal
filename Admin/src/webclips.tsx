...
export default function Webclips(){
    ...
    <div className="w-[25%] relative left-[0%] grid grid-rows-1 grid-cols-2">
        <div className={"hover:cursor-pointer" + (pageOn=="active" ? " bg-rose-700" : " bg-rose-600")}><h3 className="text-xl">Active webclips</h3></div>
        <div className={"hover:cursor-pointer" + (pageOn=="inactive" ? " bg-rose-700" : " bg-rose-600")}><h3 className="text-xl">Inactive webclips</h3></div>
    </div>
